...
class MovieIDPredictor(nn.Module):
    def __init__(self, num_movie_ids, movie_id_embedding_dim=64, transformer_heads=8, transformer_layers=1, transformer_dim=64):
        ...
        self.movie_id_embedding_dim = movie_id_embedding_dim # movie id embedding dimension
        ...
        self.fc_out = nn.Linear(self.transformer_dim, num_movie_ids) # output layer
    ...
    def forward(self, movie_id):
        ...
        x = x.view(-1, self.transformer_dim) # reshape
